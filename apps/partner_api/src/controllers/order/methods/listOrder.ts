...
import { OrdersListerFromPartnersUseCase } from '@core/useCases/order/OrdersListerFromPartners.useCase';
...
export const listOrder = async (
  ...
  const ordersListerUseCase = container.resolve(OrdersListerFromPartnersUseCase);
