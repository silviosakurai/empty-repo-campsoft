...
export const fiAccountsSplitRulesList = mysqlTable("fi_contas_split_regra_lista", {
  id_fi_contas_split_regra_lista: int("id_fi_contas_split_regra_lista").notNull().primaryKey(),
  ...
  divisao: mysqlEnum("divisao", ["fixo", "porcentagem"]).default("porcentagem"),
  valor: float("valor"),
  ...
  transferencia_automatica: mysqlEnum("transferencia_automatica", ["Y", "N"]).default("Y"),
  transferencia_intervalo: mysqlEnum("transferencia_intervalo", ["diario", "semanal", "mensal"]).default("mensal"),
  transferencia_dia: int("transferencia_dia").default(1),
  antecipacao_ativa: mysqlEnum("antecipacao_ativa", ["Y", "N"]).default("N"),
  antecipacao_tipo: mysqlEnum("antecipacao_tipo", ["full", "1025"]).default("full"),
