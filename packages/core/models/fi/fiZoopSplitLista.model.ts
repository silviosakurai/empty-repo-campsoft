...
export const fiZoopSplitLista = mysqlTable("fi_zoop_split_lista", {
  id_fi_zoop_split_lista: varchar("id_fi_zoop_split_lista", { length: 36 }).notNull().primaryKey(),
  ...
  id_fi_zoop_vendedor_conta: varchar("id_fi_zoop_vendedor_conta", { length: 32 }),
  ...
  charge_recipient_processing_fee: mysqlEnum("charge_recipient_processing_fee", ["Y", "N"]),
