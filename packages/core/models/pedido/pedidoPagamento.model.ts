...
export const pedidoPagamento = mysqlTable("pedido_pagamento", {
  id_pedido_pagamento: varbinary("id_pedido_pagamento", { length: 16 }).notNull().primaryKey().default(sql`uuid_to_bin(uuid())`),
  id_pedido_pagamento_atrelado: varbinary("id_pedido_pagamento_atrelado", { length: 16 }),
  ...
  id_assinatura_cliente_uuid: varbinary("id_assinatura_cliente_uuid", { length: 16 }),
