...
export const assinaturaCliente = mysqlTable("assinatura_cliente", {
  id_assinatura_cliente: int("id_assinatura_cliente").notNull().primaryKey(),
  id_pedido: varchar("id_pedido", { length: 16 }),
